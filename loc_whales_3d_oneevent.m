...
% Version to locate 1 event at a time in 3d
clear
...
load(name_mapping,'CC1_ind','alpha','max_samlag','pair1','x_no','y_no','z_no')
...
% Cleaning
clearvars -except CC1_ind alpha max_samlag pair1 x_no y_no z_no grid0 ...
